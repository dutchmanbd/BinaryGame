...
public class OctalHard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_octal_hard);
    ...
    private void init(){
        ...
        // Row 1
        btnRow11 = (Button) findViewById(R.id.btnRowH11O);
        btnRow12 = (Button) findViewById(R.id.btnRowH12O);
        btnRow13 = (Button) findViewById(R.id.btnRowH13O);
        btnRow14 = (Button) findViewById(R.id.btnRowH14O);
        btnRow15 = (Button) findViewById(R.id.btnRowH15O);
        btnRow16 = (Button) findViewById(R.id.btnRowH16O);
        btnRow17 = (Button) findViewById(R.id.btnRowH17O);
        btnRow18 = (Button) findViewById(R.id.btnRowH18O);
        btnRow19 = (Button) findViewById(R.id.btnRowH19O);

        // Row 2
        btnRow21 = (Button) findViewById(R.id.btnRowH21O);
        btnRow22 = (Button) findViewById(R.id.btnRowH22O);
        btnRow23 = (Button) findViewById(R.id.btnRowH23O);
        btnRow24 = (Button) findViewById(R.id.btnRowH24O);
        btnRow25 = (Button) findViewById(R.id.btnRowH25O);
        btnRow26 = (Button) findViewById(R.id.btnRowH26O);
        btnRow27 = (Button) findViewById(R.id.btnRowH27O);
        btnRow28 = (Button) findViewById(R.id.btnRowH28O);
        btnRow29 = (Button) findViewById(R.id.btnRowH29O);

        // Row 3
        btnRow31 = (Button) findViewById(R.id.btnRowH31O);
        btnRow32 = (Button) findViewById(R.id.btnRowH32O);
        btnRow33 = (Button) findViewById(R.id.btnRowH33O);
        btnRow34 = (Button) findViewById(R.id.btnRowH34O);
        btnRow35 = (Button) findViewById(R.id.btnRowH35O);
        btnRow36 = (Button) findViewById(R.id.btnRowH36O);
        btnRow37 = (Button) findViewById(R.id.btnRowH37O);
        btnRow38 = (Button) findViewById(R.id.btnRowH38O);
        btnRow39 = (Button) findViewById(R.id.btnRowH39O);


        // Row 4
        btnRow41 = (Button) findViewById(R.id.btnRowH41O);
        btnRow42 = (Button) findViewById(R.id.btnRowH42O);
        btnRow43 = (Button) findViewById(R.id.btnRowH43O);
        btnRow44 = (Button) findViewById(R.id.btnRowH44O);
        btnRow45 = (Button) findViewById(R.id.btnRowH45O);
        btnRow46 = (Button) findViewById(R.id.btnRowH46O);
        btnRow47 = (Button) findViewById(R.id.btnRowH47O);
        btnRow48 = (Button) findViewById(R.id.btnRowH48O);
        btnRow49 = (Button) findViewById(R.id.btnRowH49O);

        // Row 5
        btnRow51 = (Button) findViewById(R.id.btnRowH51O);
        btnRow52 = (Button) findViewById(R.id.btnRowH52O);
        btnRow53 = (Button) findViewById(R.id.btnRowH53O);
        btnRow54 = (Button) findViewById(R.id.btnRowH54O);
        btnRow55 = (Button) findViewById(R.id.btnRowH55O);
        btnRow56 = (Button) findViewById(R.id.btnRowH56O);
        btnRow57 = (Button) findViewById(R.id.btnRowH57O);
        btnRow58 = (Button) findViewById(R.id.btnRowH58O);
        btnRow59 = (Button) findViewById(R.id.btnRowH59O);


        // Row 6
        btnRow61 = (Button) findViewById(R.id.btnRowH61O);
        btnRow62 = (Button) findViewById(R.id.btnRowH62O);
        btnRow63 = (Button) findViewById(R.id.btnRowH63O);
        btnRow64 = (Button) findViewById(R.id.btnRowH64O);
        btnRow65 = (Button) findViewById(R.id.btnRowH65O);
        btnRow66 = (Button) findViewById(R.id.btnRowH66O);
        btnRow67 = (Button) findViewById(R.id.btnRowH67O);
        btnRow68 = (Button) findViewById(R.id.btnRowH68O);
        btnRow69 = (Button) findViewById(R.id.btnRowH69O);


        // Row 7
        btnRow71 = (Button) findViewById(R.id.btnRowH71O);
        btnRow72 = (Button) findViewById(R.id.btnRowH72O);
        btnRow73 = (Button) findViewById(R.id.btnRowH73O);
        btnRow74 = (Button) findViewById(R.id.btnRowH74O);
        btnRow75 = (Button) findViewById(R.id.btnRowH75O);
        btnRow76 = (Button) findViewById(R.id.btnRowH76O);
        btnRow77 = (Button) findViewById(R.id.btnRowH77O);
        btnRow78 = (Button) findViewById(R.id.btnRowH78O);
        btnRow79 = (Button) findViewById(R.id.btnRowH79O);


        // Row 8
        btnRow81 = (Button) findViewById(R.id.btnRowH81O);
        btnRow82 = (Button) findViewById(R.id.btnRowH82O);
        btnRow83 = (Button) findViewById(R.id.btnRowH83O);
        btnRow84 = (Button) findViewById(R.id.btnRowH84O);
        btnRow85 = (Button) findViewById(R.id.btnRowH85O);
        btnRow86 = (Button) findViewById(R.id.btnRowH86O);
        btnRow87 = (Button) findViewById(R.id.btnRowH87O);
        btnRow88 = (Button) findViewById(R.id.btnRowH88O);
        btnRow89 = (Button) findViewById(R.id.btnRowH89O);


        // Row 9
        btnRow91 = (Button) findViewById(R.id.btnRowH91O);
        btnRow92 = (Button) findViewById(R.id.btnRowH92O);
        btnRow93 = (Button) findViewById(R.id.btnRowH93O);
        btnRow94 = (Button) findViewById(R.id.btnRowH94O);
        btnRow95 = (Button) findViewById(R.id.btnRowH95O);
        btnRow96 = (Button) findViewById(R.id.btnRowH96O);
        btnRow97 = (Button) findViewById(R.id.btnRowH97O);
        btnRow98 = (Button) findViewById(R.id.btnRowH98O);


        //TextView Timer

        tvTimer  = (TextView) findViewById(R.id.tvTimerOH);
        ...
        for(int i=1; i<=8; i++) {
            ...
            if(i == 1)
                btnRow19.setText(oct);
            else if(i == 2)
                btnRow29.setText(oct);
            else if(i == 3)
                btnRow39.setText(oct);
            else if(i == 4)
                btnRow49.setText(oct);
            else if(i == 5)
                btnRow59.setText(oct);
            else if(i == 6)
                btnRow69.setText(oct);
            else if(i == 7)
                btnRow79.setText(oct);
            else if(i == 8)
                btnRow89.setText(oct);
        ...
        for(int row=0; row<8; row++) {
            ...
            if(row == 0)
                btnRow91.setText(oct);

            else if(row == 1)
                btnRow92.setText(oct);

            else if(row == 2)
                btnRow93.setText(oct);

            else if(row == 3)
                btnRow94.setText(oct);

            else if(row == 4)
                btnRow95.setText(oct);

            else if(row == 5)
                btnRow96.setText(oct);

            else if(row == 6)
                btnRow97.setText(oct);

            else if(row == 7)
                btnRow98.setText(oct);
    ...
    private void allRowCompleted(){
        ...
        if((isCompleteRow1 && isCompleteRow2 && isCompleteRow3 && isCompleteRow4 && isCompleteRow5 && isCompleteRow6 && isCompleteRow7 && isCompleteRow8)
            ...
            score.setData(KeyWords.OCT_HARD,temp);

            totalTime += temp;

            ScoreIntentData intentData = new ScoreIntentData(KeyWords.OCT_HARD, Integer.toString(temp), Integer.toString(totalTime));

            Intent intent = new Intent(OctalHard.this,NextStepForEasy.class);
            intent.putExtra(KeyWords.INTENT_DATA, (Serializable) intentData);

//            Intent intent = new Intent(OctalHard.this,NextStepForEasy.class);
//            intent.putExtra(KeyWords.CONGRETS_MSG,"Congratulations!");
//            intent.putExtra(KeyWords.TIME_MSG,"Your total time for Octal Hard round is:");
//            intent.putExtra(KeyWords.KEY_TYPE,KeyWords.OCT_HARD);
//            intent.putExtra(KeyWords.TOTALTIME,totalTime);
    ...
    private boolean checkNumVRow(int j){
        ...
        switch(j) {
            ...
            case 0:
                ...
                gNum = Integer.parseInt(btnRow91.getText().toString().trim(),8);
                break;
            ...
            case 1:
                ...
                gNum = Integer.parseInt(btnRow92.getText().toString().trim(),8);
                break;
            ...
            case 2:
                ...
                gNum = Integer.parseInt(btnRow93.getText().toString().trim(),8);
                break;
            ...
            case 3:
                ...
                gNum = Integer.parseInt(btnRow94.getText().toString().trim(),8);
                break;
            ...
            case 4:
                ...
                gNum = Integer.parseInt(btnRow95.getText().toString().trim(),8);
                break;
            ...
            case 5:
                ...
                gNum = Integer.parseInt(btnRow96.getText().toString().trim(),8);
                break;
            ...
            case 6:
                ...
                gNum = Integer.parseInt(btnRow97.getText().toString().trim(),8);
                break;
            ...
            case 7:
                ...
                gNum = Integer.parseInt(btnRow98.getText().toString().trim(),8);
                break;
    ...
    private boolean checkNumRow1(){
        ...
        int gn = Integer.parseInt(btnRow19.getText().toString(),8);
    ...
    private boolean checkNumRow2(){
        ...
        int gn = Integer.parseInt(btnRow29.getText().toString(),8);
    ...
    private boolean checkNumRow3(){
        ...
        int gn = Integer.parseInt(btnRow39.getText().toString(),8);
    ...
    private boolean checkNumRow4(){
        ...
        int gn = Integer.parseInt(btnRow49.getText().toString(),8);
    ...
    private boolean checkNumRow5(){
        ...
        int gn = Integer.parseInt(btnRow59.getText().toString(),8);
    ...
    private boolean checkNumRow6(){
        ...
        int gn = Integer.parseInt(btnRow69.getText().toString(),8);
    ...
    private boolean checkNumRow7(){
        ...
        int gn = Integer.parseInt(btnRow79.getText().toString(),8);
    ...
    private boolean checkNumRow8(){
        ...
        int gn = Integer.parseInt(btnRow89.getText().toString(),8);
