...
public class DecimalHard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal_hard);
    ...
    private void init(){
        ...
        // Row 1
        btnRow11 = (Button) findViewById(R.id.btnRowH11);
        btnRow12 = (Button) findViewById(R.id.btnRowH12);
        btnRow13 = (Button) findViewById(R.id.btnRowH13);
        btnRow14 = (Button) findViewById(R.id.btnRowH14);
        btnRow15 = (Button) findViewById(R.id.btnRowH15);
        btnRow16 = (Button) findViewById(R.id.btnRowH16);
        btnRow17 = (Button) findViewById(R.id.btnRowH17);
        btnRow18 = (Button) findViewById(R.id.btnRowH18);
        btnRow19 = (Button) findViewById(R.id.btnRowH19);

        // Row 2
        btnRow21 = (Button) findViewById(R.id.btnRowH21);
        btnRow22 = (Button) findViewById(R.id.btnRowH22);
        btnRow23 = (Button) findViewById(R.id.btnRowH23);
        btnRow24 = (Button) findViewById(R.id.btnRowH24);
        btnRow25 = (Button) findViewById(R.id.btnRowH25);
        btnRow26 = (Button) findViewById(R.id.btnRowH26);
        btnRow27 = (Button) findViewById(R.id.btnRowH27);
        btnRow28 = (Button) findViewById(R.id.btnRowH28);
        btnRow29 = (Button) findViewById(R.id.btnRowH29);

        // Row 3
        btnRow31 = (Button) findViewById(R.id.btnRowH31);
        btnRow32 = (Button) findViewById(R.id.btnRowH32);
        btnRow33 = (Button) findViewById(R.id.btnRowH33);
        btnRow34 = (Button) findViewById(R.id.btnRowH34);
        btnRow35 = (Button) findViewById(R.id.btnRowH35);
        btnRow36 = (Button) findViewById(R.id.btnRowH36);
        btnRow37 = (Button) findViewById(R.id.btnRowH37);
        btnRow38 = (Button) findViewById(R.id.btnRowH38);
        btnRow39 = (Button) findViewById(R.id.btnRowH39);


        // Row 4
        btnRow41 = (Button) findViewById(R.id.btnRowH41);
        btnRow42 = (Button) findViewById(R.id.btnRowH42);
        btnRow43 = (Button) findViewById(R.id.btnRowH43);
        btnRow44 = (Button) findViewById(R.id.btnRowH44);
        btnRow45 = (Button) findViewById(R.id.btnRowH45);
        btnRow46 = (Button) findViewById(R.id.btnRowH46);
        btnRow47 = (Button) findViewById(R.id.btnRowH47);
        btnRow48 = (Button) findViewById(R.id.btnRowH48);
        btnRow49 = (Button) findViewById(R.id.btnRowH49);

        // Row 5
        btnRow51 = (Button) findViewById(R.id.btnRowH51);
        btnRow52 = (Button) findViewById(R.id.btnRowH52);
        btnRow53 = (Button) findViewById(R.id.btnRowH53);
        btnRow54 = (Button) findViewById(R.id.btnRowH54);
        btnRow55 = (Button) findViewById(R.id.btnRowH55);
        btnRow56 = (Button) findViewById(R.id.btnRowH56);
        btnRow57 = (Button) findViewById(R.id.btnRowH57);
        btnRow58 = (Button) findViewById(R.id.btnRowH58);
        btnRow59 = (Button) findViewById(R.id.btnRowH59);


        // Row 6
        btnRow61 = (Button) findViewById(R.id.btnRowH61);
        btnRow62 = (Button) findViewById(R.id.btnRowH62);
        btnRow63 = (Button) findViewById(R.id.btnRowH63);
        btnRow64 = (Button) findViewById(R.id.btnRowH64);
        btnRow65 = (Button) findViewById(R.id.btnRowH65);
        btnRow66 = (Button) findViewById(R.id.btnRowH66);
        btnRow67 = (Button) findViewById(R.id.btnRowH67);
        btnRow68 = (Button) findViewById(R.id.btnRowH68);
        btnRow69 = (Button) findViewById(R.id.btnRowH69);


        // Row 7
        btnRow71 = (Button) findViewById(R.id.btnRowH71);
        btnRow72 = (Button) findViewById(R.id.btnRowH72);
        btnRow73 = (Button) findViewById(R.id.btnRowH73);
        btnRow74 = (Button) findViewById(R.id.btnRowH74);
        btnRow75 = (Button) findViewById(R.id.btnRowH75);
        btnRow76 = (Button) findViewById(R.id.btnRowH76);
        btnRow77 = (Button) findViewById(R.id.btnRowH77);
        btnRow78 = (Button) findViewById(R.id.btnRowH78);
        btnRow79 = (Button) findViewById(R.id.btnRowH79);


        // Row 8
        btnRow81 = (Button) findViewById(R.id.btnRowH81);
        btnRow82 = (Button) findViewById(R.id.btnRowH82);
        btnRow83 = (Button) findViewById(R.id.btnRowH83);
        btnRow84 = (Button) findViewById(R.id.btnRowH84);
        btnRow85 = (Button) findViewById(R.id.btnRowH85);
        btnRow86 = (Button) findViewById(R.id.btnRowH86);
        btnRow87 = (Button) findViewById(R.id.btnRowH87);
        btnRow88 = (Button) findViewById(R.id.btnRowH88);
        btnRow89 = (Button) findViewById(R.id.btnRowH89);


        // Row 9
        btnRow91 = (Button) findViewById(R.id.btnRowH91);
        btnRow92 = (Button) findViewById(R.id.btnRowH92);
        btnRow93 = (Button) findViewById(R.id.btnRowH93);
        btnRow94 = (Button) findViewById(R.id.btnRowH94);
        btnRow95 = (Button) findViewById(R.id.btnRowH95);
        btnRow96 = (Button) findViewById(R.id.btnRowH96);
        btnRow97 = (Button) findViewById(R.id.btnRowH97);
        btnRow98 = (Button) findViewById(R.id.btnRowH98);


        //TextView Timer

        tvTimer  = (TextView) findViewById(R.id.tvTimerH);
        ...
        for(int i=1; i<=8; i++) {
            ...
            if(i == 1)
                btnRow19.setText(String.valueOf(num));
            else if(i == 2)
                btnRow29.setText(String.valueOf(num));
            else if(i == 3)
                btnRow39.setText(String.valueOf(num));
            else if(i == 4)
                btnRow49.setText(String.valueOf(num));
            else if(i == 5)
                btnRow59.setText(String.valueOf(num));
            else if(i == 6)
                btnRow69.setText(String.valueOf(num));
            else if(i == 7)
                btnRow79.setText(String.valueOf(num));
            else if(i == 8)
                btnRow89.setText(String.valueOf(num));
        ...
        for(int row=0; row<8; row++) {
            ...
            if(row == 0)
                btnRow91.setText(String.valueOf(decNum));

            else if(row == 1)
                btnRow92.setText(String.valueOf(decNum));

            else if(row == 2)
                btnRow93.setText(String.valueOf(decNum));

            else if(row == 3)
                btnRow94.setText(String.valueOf(decNum));

            else if(row == 4)
                btnRow95.setText(String.valueOf(decNum));

            else if(row == 5)
                btnRow96.setText(String.valueOf(decNum));

            else if(row == 6)
                btnRow97.setText(String.valueOf(decNum));

            else if(row == 7)
                btnRow98.setText(String.valueOf(decNum));
    ...
    private void allRowCompleted(){
        ...
        if((isCompleteRow1 && isCompleteRow2 && isCompleteRow3 && isCompleteRow4 && isCompleteRow5 && isCompleteRow6 && isCompleteRow7 && isCompleteRow8)
            ...
            score.setData(KeyWords.DEC_HARD,temp);

            totalTime += temp;

            ScoreIntentData intentData = new ScoreIntentData(KeyWords.DEC_HARD, Integer.toString(temp), Integer.toString(totalTime));

            Intent intent = new Intent(DecimalHard.this,NextStepForEasy.class);
            intent.putExtra(KeyWords.INTENT_DATA, (Serializable) intentData);

//            Intent intent = new Intent(DecimalHard.this,NextStepForEasy.class);
//            intent.putExtra(KeyWords.CONGRETS_MSG,"Congratulations!");
//            intent.putExtra(KeyWords.TIME_MSG,"Your total time for Decimal Hard round is:");
//            intent.putExtra(KeyWords.KEY_TYPE,KeyWords.DEC_HARD);
...
//        }
        ...
        switch(j) {
            ...
            case 0:
                ...
                gNum = Integer.parseInt(btnRow91.getText().toString().trim());
                break;
            ...
            case 1:
                ...
                gNum = Integer.parseInt(btnRow92.getText().toString().trim());
                break;
            ...
            case 2:
                ...
                gNum = Integer.parseInt(btnRow93.getText().toString().trim());
                break;
            ...
            case 3:
                ...
                gNum = Integer.parseInt(btnRow94.getText().toString().trim());
                break;
            ...
            case 4:
                ...
                gNum = Integer.parseInt(btnRow95.getText().toString().trim());
                break;
            ...
            case 5:
                ...
                gNum = Integer.parseInt(btnRow96.getText().toString().trim());
                break;
            ...
            case 6:
                ...
                gNum = Integer.parseInt(btnRow97.getText().toString().trim());
                break;
            ...
            case 7:
                ...
                gNum = Integer.parseInt(btnRow98.getText().toString().trim());
                break;
    ...
    private boolean checkNumRow1(){
        ...
        int gn = Integer.parseInt(btnRow19.getText().toString());
    ...
    private boolean checkNumRow2(){
        ...
        int gn = Integer.parseInt(btnRow29.getText().toString());
    ...
    private boolean checkNumRow3(){
        ...
        int gn = Integer.parseInt(btnRow39.getText().toString());
    ...
    private boolean checkNumRow4(){
        ...
        int gn = Integer.parseInt(btnRow49.getText().toString());
    ...
    private boolean checkNumRow5(){
        ...
        int gn = Integer.parseInt(btnRow59.getText().toString());
    ...
    private boolean checkNumRow6(){
        ...
        int gn = Integer.parseInt(btnRow69.getText().toString());
    ...
    private boolean checkNumRow7(){
        ...
        int gn = Integer.parseInt(btnRow79.getText().toString());
    ...
    private boolean checkNumRow8(){
        ...
        int gn = Integer.parseInt(btnRow89.getText().toString());
