...
public class OctalMedium extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_octal_medium);
    ...
    private void init(){
        ...
        // Row 1
        btnRow11 = (Button) findViewById(R.id.btnRowOM11);
        btnRow12 = (Button) findViewById(R.id.btnRowOM12);
        btnRow13 = (Button) findViewById(R.id.btnRowOM13);
        btnRow14 = (Button) findViewById(R.id.btnRowOM14);
        btnRow15 = (Button) findViewById(R.id.btnRowOM15);
        btnRow16 = (Button) findViewById(R.id.btnRowOM16);
        btnRow17 = (Button) findViewById(R.id.btnRowOM17);

        // Row 2
        btnRow21 = (Button) findViewById(R.id.btnRowOM21);
        btnRow22 = (Button) findViewById(R.id.btnRowOM22);
        btnRow23 = (Button) findViewById(R.id.btnRowOM23);
        btnRow24 = (Button) findViewById(R.id.btnRowOM24);
        btnRow25 = (Button) findViewById(R.id.btnRowOM25);
        btnRow26 = (Button) findViewById(R.id.btnRowOM26);
        btnRow27 = (Button) findViewById(R.id.btnRowOM27);

        // Row 3
        btnRow31 = (Button) findViewById(R.id.btnRowOM31);
        btnRow32 = (Button) findViewById(R.id.btnRowOM32);
        btnRow33 = (Button) findViewById(R.id.btnRowOM33);
        btnRow34 = (Button) findViewById(R.id.btnRowOM34);
        btnRow35 = (Button) findViewById(R.id.btnRowOM35);
        btnRow36 = (Button) findViewById(R.id.btnRowOM36);
        btnRow37 = (Button) findViewById(R.id.btnRowOM37);


        // Row 4
        btnRow41 = (Button) findViewById(R.id.btnRowOM41);
        btnRow42 = (Button) findViewById(R.id.btnRowOM42);
        btnRow43 = (Button) findViewById(R.id.btnRowOM43);
        btnRow44 = (Button) findViewById(R.id.btnRowOM44);
        btnRow45 = (Button) findViewById(R.id.btnRowOM45);
        btnRow46 = (Button) findViewById(R.id.btnRowOM46);
        btnRow47 = (Button) findViewById(R.id.btnRowOM47);

        // Row 5
        btnRow51 = (Button) findViewById(R.id.btnRowOM51);
        btnRow52 = (Button) findViewById(R.id.btnRowOM52);
        btnRow53 = (Button) findViewById(R.id.btnRowOM53);
        btnRow54 = (Button) findViewById(R.id.btnRowOM54);
        btnRow55 = (Button) findViewById(R.id.btnRowOM55);
        btnRow56 = (Button) findViewById(R.id.btnRowOM56);
        btnRow57 = (Button) findViewById(R.id.btnRowOM57);


        // Row 6
        btnRow61 = (Button) findViewById(R.id.btnRowOM61);
        btnRow62 = (Button) findViewById(R.id.btnRowOM62);
        btnRow63 = (Button) findViewById(R.id.btnRowOM63);
        btnRow64 = (Button) findViewById(R.id.btnRowOM64);
        btnRow65 = (Button) findViewById(R.id.btnRowOM65);
        btnRow66 = (Button) findViewById(R.id.btnRowOM66);
        btnRow67 = (Button) findViewById(R.id.btnRowOM67);


        // Row 7
        btnRow71 = (Button) findViewById(R.id.btnRowOM71);
        btnRow72 = (Button) findViewById(R.id.btnRowOM72);
        btnRow73 = (Button) findViewById(R.id.btnRowOM73);
        btnRow74 = (Button) findViewById(R.id.btnRowOM74);
        btnRow75 = (Button) findViewById(R.id.btnRowOM75);
        btnRow76 = (Button) findViewById(R.id.btnRowOM76);


        //TextView Timer

        tvTimer  = (TextView) findViewById(R.id.tvTimerOM);
        ...
        for(int i=1; i<=6; i++) {
            ...
            if(i == 1)
                btnRow17.setText(oct);
            else if(i == 2)
                btnRow27.setText(oct);
            else if(i == 3)
                btnRow37.setText(oct);
            else if(i == 4)
                btnRow47.setText(oct);
            else if(i == 5)
                btnRow57.setText(oct);
            else if(i == 6)
                btnRow67.setText(oct);
        }
        ...
        for(int row=0; row<6; row++) {
            ...
            if(row == 0)
                btnRow71.setText(oct);

            else if(row == 1)
                btnRow72.setText(oct);
            else if(row == 2)
                btnRow73.setText(oct);
            else if(row == 3)
                btnRow74.setText(oct);

            else if(row == 4)
                btnRow75.setText(oct);

            else if(row == 5)
                btnRow76.setText(oct);
        }
    ...
    private void allRowCompleted(){
        ...
        if((isCompleteRow1 && isCompleteRow2 && isCompleteRow3 && isCompleteRow4 && isCompleteRow5 && isCompleteRow6)
            ...
            score.setData(KeyWords.OCT_MEDIUM,temp);

            totalTime += temp;

            ScoreIntentData intentData = new ScoreIntentData(KeyWords.OCT_MEDIUM, Integer.toString(temp), Integer.toString(totalTime));

            Intent intent = new Intent(OctalMedium.this,NextStepForEasy.class);
            intent.putExtra(KeyWords.INTENT_DATA, (Serializable) intentData);
//            Intent intent = new Intent(OctalMedium.this,NextStepForEasy.class);
//            intent.putExtra(KeyWords.CONGRETS_MSG,"Congratulations!");
//            intent.putExtra(KeyWords.TIME_MSG,"Your total time for Octal Medium round is:");
//            intent.putExtra(KeyWords.KEY_TYPE,KeyWords.OCT_MEDIUM);
//            intent.putExtra(KeyWords.TOTALTIME,totalTime);
    ...
    private boolean checkNumVRow(int j){
        ...
        switch(j) {
            ...
            case 0:
                ...
                gNum = Integer.parseInt(btnRow71.getText().toString().trim(),8);
                break;
            ...
            case 1:
                ...
                gNum = Integer.parseInt(btnRow72.getText().toString().trim(),8);
                break;
            ...
            case 2:
                ...
                gNum = Integer.parseInt(btnRow73.getText().toString().trim(),8);
                break;
            ...
            case 3:
                ...
                gNum = Integer.parseInt(btnRow74.getText().toString().trim(),8);
                break;
            ...
            case 4:
                ...
                gNum = Integer.parseInt(btnRow75.getText().toString().trim(),8);
                break;
            ...
            case 5:
                ...
                gNum = Integer.parseInt(btnRow76.getText().toString().trim(),8);
                break;
    ...
    private boolean checkNumRow1(){
        ...
        int gn = Integer.parseInt(btnRow17.getText().toString(),8);
    ...
    private boolean checkNumRow2(){
        ...
        int gn = Integer.parseInt(btnRow27.getText().toString(),8);
    ...
    private boolean checkNumRow3(){
        ...
        int gn = Integer.parseInt(btnRow37.getText().toString(),8);
    ...
    private boolean checkNumRow4(){
        ...
        int gn = Integer.parseInt(btnRow47.getText().toString(),8);
    ...
    private boolean checkNumRow5(){
        ...
        int gn = Integer.parseInt(btnRow57.getText().toString(),8);
    ...
    private boolean checkNumRow6(){
        ...
        int gn = Integer.parseInt(btnRow67.getText().toString(),8);
